...
! function(a, b) {
	...
	n.prototype.__requestJSONP = function(a) {
		...
		if(i.getJSON ? (n = "GET", p += "&" + f(i.postdata)) : i.postJSON && (n = "POST", o = f(i.postdata)), k.open(n, p, !0), k.withCredentials = !0, k.setRequestHeader("Accept", "application/json"), k.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), h.headers)
			for(var q in h.headers) k.setRequestHeader(q, h.headers[q]);
...
}(window, window.lib || (window.lib = {})); /* 2017-09-19 14:35:19 */
! function(t) {
	function e(o) {
	...
	var r = n(1),
		...
		f = a.ctl = {
			noConflict: function() {
				return a.ctl === f && (a.ctl = s), f
			},
			config: function(t, e) {
				if(!a.UA_Opt || !a.UA_Opt.LogVal) return e || (e = t, t = "def"), t = (t + "").toLowerCase(), e = i.extend(l, c.map[t] || c.map.def, e || {}), l.LogVal && (a[l.LogVal] = ""), e
			},
			getUA: function() {
				var t = o();
				return l.Token = (new Date).getTime() + ":" + Math.random(), l.reload && l.reload(), t
			},
			...
			ready: function(t, e) {
				return p.promise.then(t, e), p.promise
			}
		};
	f.config();
	var d = i.loadScript(c.url.uac),
		h = i.loadScript(c.url.umid),
		p = r.defer(),
		m = null;
	h.then(function() {
		var t = document.getElementById("_umfp");
		m = umx.init({
			serviceLocation: c.env,
			containers: {
				flash: t,
				dcp: t
			}
	...
	function n(t) {
		return this instanceof n ? (this._state = s, this._onFulfilled = [], this._onRejected = [], this._value = null, this._reason = null, void(d(t) && t(i(this.resolve, this), i(this.reject, this)))) : new n(t)
	}

	function o(t, e) {
		if(t === e) return void t.reject(new TypeError("A promise cannot be resolved with itself."));
		if(c(e)) try {
			e.then(function(e) {
				o(t, e)
			}, function(e) {
	...
	function i(t, e) {
		var n = [].slice,
			...
			r = function() {},
			c = function() {
				return t.apply(this instanceof r ? this : e, o.concat(n.call(arguments)))
			};
		return r.prototype = t.prototype, c.prototype = new r, c
	}
	...
	n.prototype = {
		...
		then: function(t, e) {
			var o = new n;
			return this._onFulfilled.push(r(o, t, "resolve")), this._onRejected.push(r(o, e, "reject")), this.flush(), o
		},
		flush: function() {
			var t = this._state;
			if(t !== s) {
				var e = t === l ? this._onFulfilled.slice() : this._onRejected.slice(),
					n = t === l ? this._value : this._reason;
				setTimeout(function() {
					a(e, function(t) {
						try {
							t(n)
		...
		resolve: function(t) {
			this._state === s && (this._state = l, this._value = t, this.flush())
		},
		reject: function(t) {
			this._state === s && (this._state = f, this._reason = t, this.flush())
		},
		always: function(t) {
	...
	function o(t) {
		function e() {
			o.onreadystatechange = o.onload = null, c.removeChild(o), o = null, n.resolve()
		}
		var n = i.defer(),
			o = r.createElement("script");
		return o.charset = "utf-8", o.async = !0, "onload" in o ? o.onload = e : o.onreadystatechange = function() {
			/loaded|complete/.test(o.readyState) && e()
		}, "onerror" in o && (o.onerror = function() {
			n.reject()
		}), setTimeout(function() {
			n.reject()
		}, 3e3), o.src = t, c.appendChild(o), n.promise
	}
	...
	t.exports = {
		loadScript: o,
		extend: function(t) {
			for(var e, n, o = [].slice.call(arguments), r = o.length, c = 1; c < r; c++) {
				e = o[c];
	...
	function o() {
		for(var t, e = document.getElementsByTagName("script"), n = /ctlv?\.js/, o = 0; o < e.length; o++)
			if(t = r(e[o]), n.test(t)) return e[o];
		return e[e.length - 1]
	}
	...
	var c = n(2),
		...
		s = {
			cn: {
				umid: "//g.alicdn.com/security/umscript/" + i + "/um.js",
				uac: "//af.alicdn.com/js/cj/" + u + ".js"
			},
			us: {
				umid: "//aeis.alicdn.com/security/umscript/" + i + "/um.js",
				uac: "//aeu.alicdn.com/js/cj/" + u + ".js"
			}
		},
		l = o().getAttribute("data-env") || "cn";
	t.exports = {
		env: l,
		url: s[l],
		map: {
	...
	t.exports = function(t) {
		...
		var n, o = [],
			...
			h = d.test(c[f]);
		return c[s] && c[s](a, n = function() {
			c.removeEventListener(a, n, r), e()
		}, r), u && c.attachEvent(l, n = function() {
			/^c/.test(c[f]) && (c.detachEvent(l, n), e())
		}), t = u ? function(e) {
			self != top ? h ? e() : o.push(e) : function() {
				try {
					i.doScroll("left")
				} catch(n) {
